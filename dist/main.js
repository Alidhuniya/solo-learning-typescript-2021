...
var area = obj.width * obj.heigth; // this will show you NaN in console but why Nan(not a number when spelling is incorrect) to correct write "height" and you'll get the expected result
console.log(area);
// Property 'heigth' does not exist on type '{ width: number; height: number; }'. Did you mean 'height'?
//correct way of doing
var obj1 = { width: 10, height: 15 };
var area1 = obj1.width * obj1.height;
console.log(area1);
